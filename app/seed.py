...
MONTHLY_METRICS = [
    # month, ad_spend (INR), leads, site_visits, bookings, revenue (INR)
    ("2026-04", 9_50_000, 360, 120, 26, 22_10_00_000),
    ("2026-05", 10_00_000, 375, 128, 28, 23_80_00_000),
    ("2026-06", 10_50_000, 392, 135, 29, 24_65_00_000),
    ("2026-07", 11_00_000, 405, 142, 31, 26_35_00_000),
    ("2026-08", 11_50_000, 418, 149, 33, 28_05_00_000),
    ("2026-09", 12_00_000, 428, 156, 34, 28_90_00_000),
]
...
CHAT_SCRIPT = [
    ...
    (models.MessageSender.ai, "Yes, it's available! It's a 2-bedroom on floor 15, sea-facing, ₹95 lakh. Are you looking to move in soon, or planning ahead?"),
